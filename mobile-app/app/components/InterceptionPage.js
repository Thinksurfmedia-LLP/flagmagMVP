...
export default function InterceptionPage({ game, activeTeam, roster, onSave, onCancel, onTeamChange, initialData }) {
    ...
    const handleSave = () => {
        onSave({
            ...
            defender,
            points, // string value
            flagPull: points !== null ? "" : flagPull, // If 'points' is selected, flag pull is cleared/ignored
        });
    };
